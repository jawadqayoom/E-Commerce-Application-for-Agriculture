...
public class TRegistration implements ActionListener{
...
//      Students sty=new Students();
    ...
    public void insertData(String AccType)
    {
		...
		try {
			...
			String sql = "INSERT INTO " + AccType +"(Tname, email, contact, accountType, Taddress, age, gender, DOB, pass)"+ "VALUES('"+t1.getText()+"','" +t7.getText()+ "','"+t6.getText()+"','" +AccType+"','"+t8.getText()+"','" + t3.getText() + "','" + gen + "',DATE '" + t4.getText() +"','" + String.valueOf(userPasswordField.getPassword()) +"')";
